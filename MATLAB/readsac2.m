function varargout=readsac2(filename,plotornot,osd)
...
% strtrim(HdrK(22,:))  % check the variables
...
HdrData=struct(...
  ...
  'GCARC',HdrF(54),...
  'IFTYPE',HdrI(1),...
  'KCMPNM',strtrim(HdrK(21,:)),...
  'KNETWK',strtrim(HdrK(22,:)),... % modified by Ting, SESAME
  'KINST',strtrim(HdrK(24,:)),...
  'KSTNM',strtrim(HdrK(1,:)),...
  'KEVNM',[HdrK(2,:),HdrK(3,:)],...
  'KUSER0',strtrim(HdrK(18,:)),...
  'LCALDA',HdrL(4),... 
  'MAG',HdrF(40),...
  'NPTS',HdrN(10),...
  'NVHDR',HdrN(7),...
